...
public class DemoRedisApplication {
    ...
    @Bean
    public
    CommandLineRunner runner(RedisTemplate<String, Product> redisTemplate){
        return args -> {
...
//            List<Object> entry = redisTemplate.opsForHash().values("products");
            ...
            // Pub/Sub
            // Phát thông tin : Publisher
            // Lắng nghe và nhận thông tin : các Subcriber


            // nơi nào phát tin thì chỉ cẩn sử dụng RedisTempalte bắn 1 message tới 1 chanel
            redisTemplate.convertAndSend("demo_chanel", "Test chanel");
        };
